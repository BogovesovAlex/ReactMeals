...
const Cart = props => {
    ...
    const confirmOrderHandler = async (userData) => {
        ...
        await fetch('https://react-http-6ed7a-default-rtdb.firebaseio.com/orders.json', {
            method: 'POST',
            body: JSON.stringify({
                user: userData,
    ...
    const cartModalContent = (
        <React.Fragment>
            ...
            {isCheckout && <Checkout onConfirmOrder={confirmOrderHandler} onCancel={props.onHideCartHandler} />}
